...
flowchart LR;
    ...
    direction TB;
        ...
        Mike_DuPont[("Mike DuPont\nBack-End Developer")];
        Unknown1[("Unknown Member\nFront-End Dev")];
        Fran_Abenza[("Fran Abenza\nUX/UI Design")];

        George_Hotz -->|Collaborates with| Dina_Shall;
        Dina_Shall -->|Coordinates with| William_Burns;
